...
This repository contains [samvera-circleci-orb](./samvera-circleci-orb), documentation, and templates to support the maintenance of projects in the [Samvera](https://github.com/samvera) Github organization.
...
$ pipenv sync
$ pipenv shell
$ pipenv run yamllint samvera-circleci-orb/src/
```
